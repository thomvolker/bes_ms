...
#   Thom Volker
#   14-05-2022
#   Simulation 7 in Volker & Klugkist "Combining support for hypotheses over 
...
#   variables. The hypothesis of interest is now wrongly specified, such that we 
#   evaluate the hypothesis {beta_2, beta_3, beta_4} < 0, corresponding to 
#   V2 < 0 & V3 < 0 & V4 < 0 in the code. 
#
# ______________________________________________________________________________
...
save.image(file = "output/07_separated_variables_3wrong.RData")
