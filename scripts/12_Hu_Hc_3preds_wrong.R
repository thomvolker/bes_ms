...
#   Thom Volker
#   14-05-2022
#   Additional simulation that is not discussed in paper for Volker & Klugkist 
#   "Combining support for hypotheses over heterogeneous studies with Bayesian 
...
#
#   In each study, the variable X_2, X_3 and X_4 are evaluated in a regression 
#   model containing an intercept and all other predictors as control variables. 
#   We evaluate the hypothesis {beta_2, beta_3, beta_4} < 0, which corresponds 
#   to V2 < 0 & V3 < 0 & V4 < 0 in the code. Note that this hypothesis is 
#   incorrect. 
#
# ______________________________________________________________________________
...
save.image(file = "output/12_Hu_Hc_3preds_wrong.RData")